 ...
 * CordovaChromeClient.
 */
public class XViewWebViewClient extends WebViewClient {

    private static final String TAG = "XViewWebViewClient";
    ...
    public XViewWebViewClient(XViewWebViewEngine parentEngine) {
    ...
    public void onReceivedHttpAuthRequest(WebView view, HttpAuthHandler handler, String host, String realm) {
        ...
        if (pluginManager != null
                && pluginManager.onReceivedHttpAuthRequest(null, new XViewCordovaHttpAuthHandler(handler), host, realm)) {
    ...
    public void onReceivedClientCertRequest(WebView view, ClientCertRequest request) {
        ...
        PluginManager pluginManager = this.parentEngine.pluginManager;
        if (pluginManager != null
                && pluginManager.onReceivedClientCertRequest(null, new XViewCordovaClientCertRequest(request))) {
            parentEngine.client.clearLoadTimeoutTimer();
            return;
        }

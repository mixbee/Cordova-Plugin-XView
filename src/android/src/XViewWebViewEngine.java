 ...
 */
public class XViewWebViewEngine implements CordovaWebViewEngine {
    public static final String TAG = "XViewWebViewEngine";

    protected final XViewWebView webView;
    protected final XViewCookieManager cookieManager;
     ...
     */
    public XViewWebViewEngine(Context context, CordovaPreferences preferences) {
        this(new XViewWebView(context), preferences);
    }

    public XViewWebViewEngine(XViewWebView webView) {
        this(webView, null);
    }

    public XViewWebViewEngine(XViewWebView webView, CordovaPreferences preferences) {
        this.preferences = preferences;
        this.webView = webView;
        cookieManager = new XViewCookieManager(webView);
    }
        ...
        nativeToJsMessageQueue.addBridgeMode(new NativeToJsMessageQueue.OnlineEventsBridgeMode(
                new NativeToJsMessageQueue.OnlineEventsBridgeMode.OnlineEventsBridgeModeDelegate() {
                    ...
                    public void runOnUiThread(Runnable r) {
                        XViewWebViewEngine.this.cordova.getActivity().runOnUiThread(r);
                    }
                }));
    ...
    private static void exposeJsInterface(WebView webView, CordovaBridge bridge) {
        ...
        XViewExposedJsApi exposedJsApi = new XViewExposedJsApi(bridge);

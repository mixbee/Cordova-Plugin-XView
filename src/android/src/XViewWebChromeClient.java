 ...
 */
public class XViewWebChromeClient extends WebChromeClient {

    private static final int FILECHOOSER_RESULTCODE = 5173;
    private static final String LOG_TAG = "XViewWebChromeClient";
    private long MAX_QUOTA = 100 * 1024 * 1024;
    protected final XViewWebViewEngine parentEngine;
    ...
    public XViewWebChromeClient(XViewWebViewEngine parentEngine) {
     ...
     * call the appropriate JsPromptResult method.
     * <p>
     * Since we are hacking prompts for our own purposes, we should not be using
     * them for this purpose, perhaps we should hack console.log to do this instead!
     */
    @Override
    ...
    public boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        if (consoleMessage.message() != null)
            LOG.d(LOG_TAG, "%s: Line %d : %s", consoleMessage.sourceId(), consoleMessage.lineNumber(),
     ...
     *
     * This also checks for the Geolocation Plugin and requests permission from the
     * application to use Geolocation.
     *
     * @param origin
     * @param callback
     */
    ...
    // TODO API level 7 is required for this, see if we could lower this using
    // something else
    // @Override
    // public void onShowCustomView(View view, IXViewWebChromeClient.CustomViewCallback
    // callback) {
